...
from Nucleic_acid_testing.views import point_message
...
urlpatterns = (
        [
            ...
            path('api/crud_demo/',include('crud_demo.urls')),
            path('api/Nucleic_acid_testing',include('Nucleic_acid_testing.urls')),
            path('api/point_message',point_message)
